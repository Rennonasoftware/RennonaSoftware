...
## 📝 Descripción
Desarrollado por **Reennona Software**, este sistema permite optimizar el soporte técnico con roles de usuario diferenciados (Administrador, Técnico y Solicitante).
